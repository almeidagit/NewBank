...
public class ContaPoupanca extends Conta {
	...
	void sacar(double valor) {
		...
		if (valor > this.getSaldo()) {
			...
			System.err.println("Saldo Atual na CONTA POUPAN�A: " + this.getSaldo());
	...
	void depositar(double valor) {
		...
		System.err.printf("Ol�, " + getNomeCliente() + "! Seu saldo Atual na CONTA POUPAN�A: " + this.getSaldo()
	...
	void abrirConta() {
		...
		System.err.println(" CADASTRO DE NOVA CONTA POUPAN�A\nDigite o NOME do cliente: ");
		this.setNomeCliente(sc.nextLine());

		this.setAgencia("1010-CP"); // Agencia possue n�mero padr�o
